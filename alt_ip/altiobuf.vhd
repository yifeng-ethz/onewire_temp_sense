...
--synthesis_resources = arriav_io_ibuf 1 arriav_io_obuf 1 
 ...
 ENTITY  altiobuf_iobuf_bidir_nho IS 
	 PORT 
	 ( 
 ...
 END altiobuf_iobuf_bidir_nho;

 ARCHITECTURE RTL OF altiobuf_iobuf_bidir_nho IS
 ...
 END RTL; --altiobuf_iobuf_bidir_nho
--VALID FILE
...
ARCHITECTURE RTL OF altiobuf IS
	...
	COMPONENT altiobuf_iobuf_bidir_nho
	PORT (
			datain	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
			oe	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
			dataout	: OUT STD_LOGIC_VECTOR (0 DOWNTO 0);
...
BEGIN
	...
	altiobuf_iobuf_bidir_nho_component : altiobuf_iobuf_bidir_nho
	PORT MAP (
		datain => datain,
		oe => oe,
		dataout => sub_wire0,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL altiobuf_inst.vhd TRUE
